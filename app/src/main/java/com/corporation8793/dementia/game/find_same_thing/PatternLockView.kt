...
class PatternLockView : GridLayout {
    ...
    constructor(context: Context, attributeSet: AttributeSet) : super(context, attributeSet) {
        ...
        lineWidth = 60
        regularLineColor = ta.getColor(R.styleable.PatternLockView_plv_regularLineColor, ContextCompat.getColor(context, R.color.gray_f5f5f5))
...
//                    selectedCells.add(hitCell)
    ...
    private fun notifyCellSelected(cell: Cell) {
        Log.e("index check",cell.index.toString())
        Log.e("text check",cell.text.toString())
